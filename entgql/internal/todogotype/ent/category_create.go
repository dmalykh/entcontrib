...
func (cc *CategoryCreate) SetID(bi bigintgql.BigInt) *CategoryCreate {
	cc.mutation.SetID(bi)
	return cc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableID(bi *bigintgql.BigInt) *CategoryCreate {
	if bi != nil {
		cc.SetID(*bi)
	}
	return cc
...
func (cc *CategoryCreate) AddTodoIDs(ids ...string) *CategoryCreate {
...
func (cc *CategoryCreate) AddSubCategoryIDs(ids ...bigintgql.BigInt) *CategoryCreate {
...
func (cc *CategoryCreate) sqlSave(ctx context.Context) (*Category, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(*bigintgql.BigInt); ok {
			_node.ID = *id
