...
func (cq *CategoryQuery) FirstID(ctx context.Context) (id bigintgql.BigInt, err error) {
	var ids []bigintgql.BigInt
...
func (cq *CategoryQuery) FirstIDX(ctx context.Context) bigintgql.BigInt {
...
func (cq *CategoryQuery) OnlyID(ctx context.Context) (id bigintgql.BigInt, err error) {
	var ids []bigintgql.BigInt
...
func (cq *CategoryQuery) OnlyIDX(ctx context.Context) bigintgql.BigInt {
...
func (cq *CategoryQuery) IDs(ctx context.Context) (ids []bigintgql.BigInt, err error) {
...
func (cq *CategoryQuery) IDsX(ctx context.Context) []bigintgql.BigInt {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CategoryQuery) loadTodos(ctx context.Context, query *TodoQuery, nodes []*Category, init func(*Category), assign func(*Category, *Todo)) error {
	...
	nodeids := make(map[bigintgql.BigInt]*Category)
	for i := range nodes {
...
func (cq *CategoryQuery) loadSubCategories(ctx context.Context, query *CategoryQuery, nodes []*Category, init func(*Category), assign func(*Category, *Category)) error {
	...
	byID := make(map[bigintgql.BigInt]*Category)
	nids := make(map[bigintgql.BigInt]map[*Category]struct{})
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.ScanValues = func(columns []string) ([]any, error) {
				...
				return append([]any{new(bigintgql.BigInt)}, values...), nil
			}
			spec.Assign = func(columns []string, values []any) error {
				outValue := *values[0].(*bigintgql.BigInt)
				inValue := *values[1].(*bigintgql.BigInt)
				if nids[inValue] == nil {
