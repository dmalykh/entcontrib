...
import (
	...
	"github.com/dmalykh/entcontrib/entgql/internal/todogotype/ent/migrate"
	...
	"github.com/dmalykh/entcontrib/entgql/internal/todogotype/ent/billproduct"
	"github.com/dmalykh/entcontrib/entgql/internal/todogotype/ent/category"
	"github.com/dmalykh/entcontrib/entgql/internal/todogotype/ent/friendship"
	...
	"github.com/dmalykh/entcontrib/entgql/internal/todogotype/ent/verysecret"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.BillProduct, c.Category, c.Friendship, c.Group, c.Pet, c.Todo, c.User,
		c.VerySecret,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		BillProduct, Category, Friendship, Group, Pet, Todo, User, VerySecret []ent.Hook
	}
	inters struct {
