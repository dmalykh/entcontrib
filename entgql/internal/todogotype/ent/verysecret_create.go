...
func (vsc *VerySecretCreate) SetID(s string) *VerySecretCreate {
	vsc.mutation.SetID(s)
	return vsc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (vsc *VerySecretCreate) SetNillableID(s *string) *VerySecretCreate {
	if s != nil {
		vsc.SetID(*s)
	}
	return vsc
...
func (vsc *VerySecretCreate) sqlSave(ctx context.Context) (*VerySecret, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected VerySecret.ID type: %T", _spec.ID.Value)
		}
	}
