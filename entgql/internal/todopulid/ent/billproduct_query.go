...
func (bpq *BillProductQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (bpq *BillProductQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (bpq *BillProductQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := bpq.IDs(ctx)
	if err != nil {
		panic(err)
	}
