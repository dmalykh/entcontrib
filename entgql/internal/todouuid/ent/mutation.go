...
func withBillProductID(id uuid.UUID) billproductOption {
...
func (m *BillProductMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *BillProductMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *BillProductMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
...
func (m *TodoMutation) SetSecretID(id uuid.UUID) {
	m.secret = &id
}
...
func (m *TodoMutation) SecretID() (id uuid.UUID, exists bool) {
	if m.secret != nil {
...
func (m *TodoMutation) SecretIDs() (ids []uuid.UUID) {
...
func withVerySecretID(id uuid.UUID) verysecretOption {
...
func (m *VerySecretMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *VerySecretMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *VerySecretMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
