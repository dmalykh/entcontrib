...
import (
	...
	"github.com/dmalykh/entcontrib/entoas/internal/simple/migrate"
	"entgo.io/ent"
...
var ErrTxStarted = errors.New("simple: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("simple: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("simple: unknown mutation type %T", m)
	}
}
...
func (c *CategoryClient) mutate(ctx context.Context, m *CategoryMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("simple: unknown Category mutation op: %q", m.Op())
	}
}
...
func (c *PetClient) mutate(ctx context.Context, m *PetMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("simple: unknown Pet mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("simple: unknown User mutation op: %q", m.Op())
	}
}
