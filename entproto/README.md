...
```console
go get -u github.com/dmalykh/entcontrib/entproto
```

Install `protoc-gen-entgrpc` (ent's gRPC service implementation generator):

```console
go get github.com/dmalykh/entcontrib/entproto/cmd/protoc-gen-entgrpc
```
...
```console
go run github.com/dmalykh/entcontrib/entproto/cmd/entproto -path ./ent/schema
```
...
option go_package = "github.com/dmalykh/entcontrib/entproto/internal/todo/ent/proto/entpb";
...
go generate ./cmd/protoc-gen-entgrpc/... &&
  go install github.com/dmalykh/entcontrib/entproto/cmd/protoc-gen-entgrpc &&
  go generate ./... &&
  go test ./...
```
