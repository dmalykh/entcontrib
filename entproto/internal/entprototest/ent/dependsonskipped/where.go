...
func ID(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldLTE(FieldID, id))
}

// Name applies equality check predicate on the "name" field. It's identical to NameEQ.
func Name(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldEQ(FieldName, v))
}
...
func NameNEQ(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldNEQ(FieldName, v))
}

// NameIn applies the In predicate on the "name" field.
func NameIn(vs ...string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldIn(FieldName, vs...))
}

// NameNotIn applies the NotIn predicate on the "name" field.
func NameNotIn(vs ...string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldNotIn(FieldName, vs...))
}

// NameGT applies the GT predicate on the "name" field.
func NameGT(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldGT(FieldName, v))
}

// NameGTE applies the GTE predicate on the "name" field.
func NameGTE(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldGTE(FieldName, v))
}

// NameLT applies the LT predicate on the "name" field.
func NameLT(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldLT(FieldName, v))
}

// NameLTE applies the LTE predicate on the "name" field.
func NameLTE(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldLTE(FieldName, v))
}

// NameContains applies the Contains predicate on the "name" field.
func NameContains(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldContains(FieldName, v))
}

// NameHasPrefix applies the HasPrefix predicate on the "name" field.
func NameHasPrefix(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldHasPrefix(FieldName, v))
}

// NameHasSuffix applies the HasSuffix predicate on the "name" field.
func NameHasSuffix(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldHasSuffix(FieldName, v))
}

// NameEqualFold applies the EqualFold predicate on the "name" field.
func NameEqualFold(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldEqualFold(FieldName, v))
}

// NameContainsFold applies the ContainsFold predicate on the "name" field.
func NameContainsFold(v string) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.FieldContainsFold(FieldName, v))
}
...
func And(predicates ...predicate.DependsOnSkipped) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.DependsOnSkipped) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.DependsOnSkipped) predicate.DependsOnSkipped {
	return predicate.DependsOnSkipped(sql.NotPredicates(p))
}
