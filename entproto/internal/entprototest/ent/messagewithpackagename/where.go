...
func ID(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldLTE(FieldID, id))
}

// Name applies equality check predicate on the "name" field. It's identical to NameEQ.
func Name(v string) predicate.MessageWithPackageName {
	return predicate.MessageWithPackageName(sql.FieldEQ(FieldName, v))
}
