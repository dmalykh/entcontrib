...
func ID(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.FieldLTE(FieldID, id))
}

// And groups predicates with the AND operator between them.
func And(predicates ...predicate.MessageWithStrings) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.MessageWithStrings) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.MessageWithStrings) predicate.MessageWithStrings {
	return predicate.MessageWithStrings(sql.NotPredicates(p))
}
